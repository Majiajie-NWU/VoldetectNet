...
path_cocoevalresult='/home/cyb/majiajie/dukewangluo/DINO-main-merge-duoqi/logs/cocoevalresult.json'
def move_to_device(nested_tensors, device):
    return [nt.to(device) for nt in nested_tensors]
